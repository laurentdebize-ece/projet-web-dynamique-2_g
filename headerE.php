...
<header>
  ...
  <nav>
    <ul class="menu">
      <li class="centered"><a href="pageEtudiant.php">Accueil</a></li>
      <li class="centered"><a href="matiereE.php">Mes matières</a></li>
      <li class="centered"><a href="competenceE.php">Mes compétences</a></li>
      <li class="centered"><a href="quisommesnousE.php"> Qui sommes nous ?</a></li>
      <li class="test">
        <a href="#">
