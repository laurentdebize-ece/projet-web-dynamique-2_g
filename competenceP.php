...
<body>
    ...
    <div class="container">
        <form action="competenceP.php" method="post" class="card">
            <button type="submit" name="tri" value='NULL' class="full-rounded">
                <span>Default</span>
                <div class="border full-rounded"></div>
            </button>
            <button type="submit" name="tri" value="1" class="full-rounded">
                <span>Croissant alphabétique</span>
                <div class="border full-rounded"></div>
            </button>
            <button type="submit" name="tri" value="2" class="full-rounded">
                <span>Décroissant alphabétique</span>
                <div class="border full-rounded"></div>
            </button>
            <button type="submit" name="tri" value="3" class="full-rounded">
                <span>Date d'évaluation croissante</span>
                <div class="border full-rounded"></div>
            </button>
            <button type="submit" name="tri" value="4" class="full-rounded">
                <span>Date Evaluation décroissante</span>
                <div class="border full-rounded"></div>
            </button>
        </form>
        <form action="competenceP.php" method="post">
            ...
            <button type="submit" name="tri" value="6" class="full-rounded"> Professeur </button><br><br>
        </form>
        <form action="competenceP.php" method="post">
            ...
            <button type="submit" name="tri" value="5" class="full-rounded"> Matiere </button>
        </form>
